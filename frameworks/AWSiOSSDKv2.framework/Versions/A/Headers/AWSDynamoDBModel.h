 ...
 */
@property (nonatomic, strong) NSNumber *NIL;
 ...
 * Required parameters: [TableName, KeyConditions]
 */
...
/**
 * <p>A condition that evaluates the query results and returns only the desired values.</p><p>The condition you specify is applied to the items queried; any items that do not match the expression are not returned.</p>
 */
@property (nonatomic, strong) NSString *filterExpression;

/**
 * <p>The name of an index to query. This index can be any local secondary index or global secondary index on the table.</p>
 */
@property (nonatomic, strong) NSString *indexName;
...
/**
 * <p>A condition that evaluates the scan results and returns only the desired values.</p><p>The condition you specify is applied to the items scanned; any items that do not match the expression are not returned.</p>
 */
@property (nonatomic, strong) NSString *filterExpression;
...
/**
 * <p>The primary key of the item to be updated. Each element consists of an attribute name and a value for that attribute.</p><p>For the primary key, you must provide all of the attributes. For example, with a hash type primary key, you only need to specify the hash attribute. For a hash-and-range type primary key, you must specify both the hash attribute and the range attribute.</p>
 */
@property (nonatomic, strong) NSDictionary *key;
 ...
 */
@property (nonatomic, strong) NSString *updateExpression;
